...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct/range {v0 .. v8}, Lcom/android/internal/widget/LockPatternView$SavedState;-><init>(Landroid/os/Parcelable;Ljava/lang/String;IBZZZLcom/android/internal/widget/LockPatternView$1;)V
...
.method public setLockPatternColor(II)V
    .locals 11
    .parameter "color"
    .parameter "colorFail"
    ...
    .local v3, mutableBitmapFail:Landroid/graphics/Bitmap;
    if-eq p1, v10, :cond_0
    ...
    .local v0, canvasFocused:Landroid/graphics/Canvas;
    ...
    invoke-direct {v6, p1, v8}, Landroid/graphics/LightingColorFilter;-><init>(II)V

    invoke-virtual {v4, v6}, Landroid/graphics/Paint;->setColorFilter(Landroid/graphics/ColorFilter;)Landroid/graphics/ColorFilter;

    invoke-virtual {v0, v2, v9, v9, v4}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V

    iput-object v2, p0, Lcom/android/internal/widget/LockPatternView;->mBitmapCircleGreen:Landroid/graphics/Bitmap;

    .end local v0           #canvasFocused:Landroid/graphics/Canvas;
    ...
    .local v1, canvasPressed:Landroid/graphics/Canvas;
    new-instance v5, Landroid/graphics/Paint;

    invoke-direct {v5}, Landroid/graphics/Paint;-><init>()V

    .local v5, paintFail:Landroid/graphics/Paint;
    invoke-virtual {v5, v8}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    new-instance v6, Landroid/graphics/LightingColorFilter;

    invoke-direct {v6, p2, v8}, Landroid/graphics/LightingColorFilter;-><init>(II)V

    invoke-virtual {v5, v6}, Landroid/graphics/Paint;->setColorFilter(Landroid/graphics/ColorFilter;)Landroid/graphics/ColorFilter;

    invoke-virtual {v1, v3, v9, v9, v5}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;FFLandroid/graphics/Paint;)V

    iput-object v3, p0, Lcom/android/internal/widget/LockPatternView;->mBitmapCircleRed:Landroid/graphics/Bitmap;

    .end local v1           #canvasPressed:Landroid/graphics/Canvas;
    .end local v2           #mutableBitmap:Landroid/graphics/Bitmap;
    .end local v3           #mutableBitmapFail:Landroid/graphics/Bitmap;
    .end local v5           #paintFail:Landroid/graphics/Paint;
    :cond_1
    return-void
.end method

...
.field private mPadDrawable:Landroid/graphics/drawable/Drawable;
...
.field private mRingDrawable:Landroid/graphics/drawable/GradientDrawable;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v6, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mPadDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    invoke-direct {v7, v4, v6}, Lcom/android/internal/widget/multiwaveview/TargetDrawable;-><init>(Landroid/content/res/Resources;I)V

    iput-object v7, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mHandleDrawable:Lcom/android/internal/widget/multiwaveview/TargetDrawable;
    ...
    iput-object v6, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mRingDrawable:Landroid/graphics/drawable/GradientDrawable;
    ...
    :goto_1
    iput-object v6, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mPointDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v0, v6, v2}, Landroid/content/res/TypedArray;->getValue(ILandroid/util/TypedValue;)Z
    ...
    iget-object v7, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mPointDrawable:Landroid/graphics/drawable/Drawable;

    invoke-direct {v6, v7}, Lcom/android/internal/widget/multiwaveview/PointCloud;-><init>(Landroid/graphics/drawable/Drawable;)V
...
.method private deactivateTargets()V
    ...
    iget-object v3, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mOnTriggerListener:Lcom/android/internal/widget/multiwaveview/GlowPadView$OnTriggerListener;

    if-eqz v3, :cond_1

    iget-object v3, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mOnTriggerListener:Lcom/android/internal/widget/multiwaveview/GlowPadView$OnTriggerListener;

    iget v4, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mActiveTarget:I

    invoke-interface {v3, p0, v4}, Lcom/android/internal/widget/multiwaveview/GlowPadView$OnTriggerListener;->onTargetChange(Landroid/view/View;I)V
...
.method handleMove(Landroid/view/MotionEvent;)V
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/internal/widget/multiwaveview/GlowPadView;->vibrate()V
    ...
    iget-object v0, v0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mOnTriggerListener:Lcom/android/internal/widget/multiwaveview/GlowPadView$OnTriggerListener;
    ...
    invoke-interface {v0, v1, v2}, Lcom/android/internal/widget/multiwaveview/GlowPadView$OnTriggerListener;->onTargetChange(Landroid/view/View;I)V
...
.method private loadDescriptions(I)Ljava/util/ArrayList;
    ...
    .local v5, targetContentDescriptions:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    const/4 v4, 0x0
...
.method private setRingDrawable(Landroid/graphics/drawable/Drawable;)V
    .locals 3
    .parameter "ring"
    ...
    iput-object v1, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mOuterRing:Lcom/android/internal/widget/multiwaveview/TargetDrawable;
...
.method public setColoredIcons(IIILandroid/graphics/Bitmap;)V
    .locals 8
    .parameter "lockColor"
    .parameter "dotColor"
    .parameter "ringColor"
    ...
    iget-object v2, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mContext:Landroid/content/Context;

    new-instance v3, Landroid/graphics/drawable/BitmapDrawable;

    iget-object v4, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mContext:Landroid/content/Context;

    invoke-virtual {v4}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v4

    invoke-static {p4}, Lcom/android/internal/util/slim/ImageHelper;->getCircleBitmap(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v2, v3, v4}, Lcom/android/internal/util/slim/ImageHelper;->resize(Landroid/content/Context;Landroid/graphics/drawable/Drawable;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    .local v0, handleDrawable:Landroid/graphics/drawable/Drawable;
    if-eq p1, v6, :cond_0
    ...
    invoke-static {v0, p1}, Lcom/android/internal/util/slim/ImageHelper;->getColoredBitmap(Landroid/graphics/drawable/Drawable;I)Landroid/graphics/Bitmap;

    move-result-object v3

    invoke-direct {v1, v2, v3}, Landroid/graphics/drawable/BitmapDrawable;-><init>(Landroid/content/res/Resources;Landroid/graphics/Bitmap;)V

    .end local v0           #handleDrawable:Landroid/graphics/drawable/Drawable;
    .local v1, handleDrawable:Landroid/graphics/drawable/Drawable;
    move-object v0, v1

    .end local v1           #handleDrawable:Landroid/graphics/drawable/Drawable;
    .restart local v0       #handleDrawable:Landroid/graphics/drawable/Drawable;
    :cond_0
    invoke-virtual {p0, v0}, Lcom/android/internal/widget/multiwaveview/GlowPadView;->setHandleDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v2, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mPointDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mRingDrawable:Landroid/graphics/drawable/GradientDrawable;
    ...
    invoke-virtual {v2, v3, p3}, Landroid/graphics/drawable/GradientDrawable;->setStroke(II)V
    ...
    invoke-direct {p0, v2}, Lcom/android/internal/widget/multiwaveview/GlowPadView;->setRingDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v2, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mPadDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v2}, Lcom/android/internal/widget/multiwaveview/GlowPadView;->setHandleDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public setDirectionDescriptions(Ljava/util/ArrayList;)V
    .locals 0
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .local p1, directionDescriptions:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    iput-object p1, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mDirectionDescriptions:Ljava/util/ArrayList;
...
.method public setTargetDescriptions(Ljava/util/ArrayList;)V
    .locals 0
    .parameter
    .annotation system Ldalvik/annotation/Signature;
        value = {
    ...
    .prologue
    .local p1, targetDescriptions:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    iput-object p1, p0, Lcom/android/internal/widget/multiwaveview/GlowPadView;->mTargetDescriptions:Ljava/util/ArrayList;

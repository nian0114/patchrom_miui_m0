...
.method private updateAmbientLux(J)V
    ...
    .prologue
    iget-boolean v10, p0, Lcom/android/server/power/DisplayPowerController;->mAmbientLuxValid:Z
    ...
    iget-wide v12, p0, Lcom/android/server/power/DisplayPowerController;->mLightSensorEnableTime:J
    ...
    invoke-virtual {v10, v11, v8, v9}, Lcom/android/server/power/DisplayPowerController$DisplayControllerHandler;->sendEmptyMessageAtTime(IJ)Z
    ...
    invoke-direct {p0, v10}, Lcom/android/server/power/DisplayPowerController;->setAmbientLux(F)V

    const/4 v10, 0x1

    iput-boolean v10, p0, Lcom/android/server/power/DisplayPowerController;->mAmbientLuxValid:Z
    ...
    const-string v12, "updateAmbientLux: Initializing: mRecentShortTermAverageLux="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p0, Lcom/android/server/power/DisplayPowerController;->mRecentShortTermAverageLux:F

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string v12, ", mRecentLongTermAverageLux="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p0, Lcom/android/server/power/DisplayPowerController;->mRecentLongTermAverageLux:F
    ...
    iget v12, p0, Lcom/android/server/power/DisplayPowerController;->mAmbientLux:F
    ...
    invoke-direct {p0, v10}, Lcom/android/server/power/DisplayPowerController;->updateAutoBrightness(Z)V
    ...
    iget v11, p0, Lcom/android/server/power/DisplayPowerController;->mRecentLongTermAverageLux:F
    ...
    iget v10, v10, Lcom/android/server/power/DisplayPowerRequest;->responsitivityFactor:F
    ...
    iget v10, p0, Lcom/android/server/power/DisplayPowerController;->mDebounceLuxDirection:I
    ...
    const-string v12, "updateAmbientLux: Possibly brightened, waiting for "
    ...
    const-string v12, "brighteningLuxThreshold="
    ...
    const-string v12, ", mRecentShortTermAverageLux="
    ...
    :cond_4
    iget-wide v10, p0, Lcom/android/server/power/DisplayPowerController;->mDebounceLuxTime:J
    ...
    iput v10, p0, Lcom/android/server/power/DisplayPowerController;->mAmbientLux:F
    ...
    const-string v12, "updateAmbientLux: Brightened: brighteningLuxThreshold="
    ...
    invoke-virtual {v10, v11, v4, v5}, Lcom/android/server/power/DisplayPowerController$DisplayControllerHandler;->sendEmptyMessageAtTime(IJ)Z
    ...
    const-string v12, "updateAmbientLux: Possibly darkened, waiting for "
    ...
    const-string v12, "darkeningLuxThreshold="
    ...
    const-string v12, "updateAmbientLux: Darkened: darkeningLuxThreshold="
    ...
    const-string v12, "updateAmbientLux: Darkened: mDarkeningLuxThreshold="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p0, Lcom/android/server/power/DisplayPowerController;->mDarkeningLuxThreshold:F
    ...
    :cond_c
    :goto_2
    iget v10, p0, Lcom/android/server/power/DisplayPowerController;->mLastObservedLux:F
    ...
    invoke-virtual {v10, v11, v12, v13}, Lcom/android/server/power/DisplayPowerController$DisplayControllerHandler;->sendEmptyMessageAtTime(IJ)Z

    goto/16 :goto_0

    .end local v6           #synthesizedDelay:J
    .restart local v2       #debounceDelay:J
    .restart local v4       #debounceTime:J
    :cond_e
    iget-object v10, p0, Lcom/android/server/power/DisplayPowerController;->mHandler:Lcom/android/server/power/DisplayPowerController$DisplayControllerHandler;
    ...
    const-string v12, "updateAmbientLux: Canceled debounce: mBrighteningLuxThreshold="

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v11

    iget v12, p0, Lcom/android/server/power/DisplayPowerController;->mBrighteningLuxThreshold:F

    invoke-virtual {v11, v12}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    move-result-object v11

    const-string v12, ", mDarkeningLuxThreshold="

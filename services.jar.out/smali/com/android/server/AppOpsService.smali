...
.method public getPrivacyGuardOpsForPackage(Ljava/lang/String;)Ljava/util/List;
    ...
    .local v8, ops:Ljava/util/List;,"Ljava/util/List<Ljava/lang/Integer;>;"
    :try_start_0
    ...
    .local v11, requestedPermissions:[Ljava/lang/String;
    if-eqz v11, :cond_1
    ...
    .local v10, requested:Ljava/lang/String;
    ...
    .end local v1           #curOp:I
    .end local v2           #duplicate:Z
    .end local v4           #i$:Ljava/util/Iterator;
    .end local v6           #len$:I
    .end local v7           #op:I
    .end local v9           #pkgInfo:Landroid/content/pm/PackageInfo;
    .end local v10           #requested:Ljava/lang/String;
    .end local v11           #requestedPermissions:[Ljava/lang/String;
    :catch_0
    move-exception v3
    ...
    .restart local v1       #curOp:I
    .restart local v2       #duplicate:Z
    .restart local v4       #i$:Ljava/util/Iterator;
    .restart local v6       #len$:I
    .restart local v9       #pkgInfo:Landroid/content/pm/PackageInfo;
    .restart local v10       #requested:Ljava/lang/String;
    .restart local v11       #requestedPermissions:[Ljava/lang/String;
    :cond_2
    const/4 v12, -0x1
...
.method public getPrivacyGuardSettingForPackage(ILjava/lang/String;)I
    ...
    .local v7, privacyGuardOps:Ljava/util/List;,"Ljava/util/List<Ljava/lang/Integer;>;"
    new-instance v8, Ljava/util/ArrayList;

    invoke-direct {v8, v7}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    .local v8, privacyGuardOpsHelper:Ljava/util/List;,"Ljava/util/List<Ljava/lang/Integer;>;"
    if-eqz v4, :cond_3
    ...
    .end local v9           #privacyGuardState:I
    :cond_4
    const/4 v9, 0x4

    .restart local v9       #privacyGuardState:I
    goto :goto_1
...
.method public setPrivacyGuardSettingForPackage(ILjava/lang/String;ZZ)V
    ...
    .local v3, switchOps:Ljava/util/List;,"Ljava/util/List<Ljava/lang/Integer;>;"
    :cond_0
    ...
    .end local v1           #op:I
    .end local v3           #switchOps:Ljava/util/List;,"Ljava/util/List<Ljava/lang/Integer;>;"
    :cond_1
    new-instance v3, Ljava/util/ArrayList;

    invoke-direct {v3}, Ljava/util/ArrayList;-><init>()V

    .restart local v3       #switchOps:Ljava/util/List;,"Ljava/util/List<Ljava/lang/Integer;>;"
    const/4 v4, 0x0
    ...
    .local v2, packageOps:Ljava/util/List;,"Ljava/util/List<Landroid/app/AppOpsManager$PackageOps;>;"
    if-eqz v2, :cond_0
    ...
    .end local v2           #packageOps:Ljava/util/List;,"Ljava/util/List<Landroid/app/AppOpsManager$PackageOps;>;"
    .local v1, op:I
    :cond_3
    move v4, v6

...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lcom/android/server/connectivity/Tethering$NotificationBroadcastReciever;,
...
# static fields
.field private static final ACTION_TURN_WIFI_AP_OFF:Ljava/lang/String; = "com.android.server.ACTION_TURN_WIFI_AP_OFF"
...
.field private static mNotificationBroadcastReceiver:Lcom/android/server/connectivity/Tethering$NotificationBroadcastReciever;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/android/server/connectivity/Tethering;->mNotificationBroadcastReceiver:Lcom/android/server/connectivity/Tethering$NotificationBroadcastReciever;
...
.method static synthetic access$3000(Lcom/android/server/connectivity/Tethering;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method private clearTetheredNotification()V
    ...
    sget-object v1, Lcom/android/server/connectivity/Tethering;->mNotificationBroadcastReceiver:Lcom/android/server/connectivity/Tethering$NotificationBroadcastReciever;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/server/connectivity/Tethering;->mContext:Landroid/content/Context;

    sget-object v2, Lcom/android/server/connectivity/Tethering;->mNotificationBroadcastReceiver:Lcom/android/server/connectivity/Tethering$NotificationBroadcastReciever;

    invoke-virtual {v1, v2}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    sput-object v3, Lcom/android/server/connectivity/Tethering;->mNotificationBroadcastReceiver:Lcom/android/server/connectivity/Tethering$NotificationBroadcastReciever;
...
.method private showTetheredNotification(I)V
    ...
    const-string v13, "com.android.server.ACTION_TURN_WIFI_AP_OFF"
    ...
    invoke-static {v3, v4, v5, v13}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v3

    invoke-virtual {v6, v0, v1, v3}, Landroid/app/Notification$Builder;->addAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Builder;

    sget-object v0, Lcom/android/server/connectivity/Tethering;->mNotificationBroadcastReceiver:Lcom/android/server/connectivity/Tethering$NotificationBroadcastReciever;

    if-nez v0, :cond_3

    new-instance v0, Lcom/android/server/connectivity/Tethering$NotificationBroadcastReciever;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, Lcom/android/server/connectivity/Tethering$NotificationBroadcastReciever;-><init>(Lcom/android/server/connectivity/Tethering;Lcom/android/server/connectivity/Tethering$1;)V

    sput-object v0, Lcom/android/server/connectivity/Tethering;->mNotificationBroadcastReceiver:Lcom/android/server/connectivity/Tethering$NotificationBroadcastReciever;

    new-instance v7, Landroid/content/IntentFilter;

    const-string v0, "com.android.server.ACTION_TURN_WIFI_AP_OFF"

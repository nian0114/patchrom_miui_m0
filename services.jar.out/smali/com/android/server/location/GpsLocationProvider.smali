...
.method public constructor <init>(Landroid/content/Context;Landroid/location/ILocationManager;Landroid/os/Looper;)V
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mLock:Ljava/lang/Object;
    ...
    iput-wide v4, p0, Lcom/android/server/location/GpsLocationProvider;->mStatusUpdateTime:J

    iput v7, p0, Lcom/android/server/location/GpsLocationProvider;->mInjectNtpTimePending:I

    iput v7, p0, Lcom/android/server/location/GpsLocationProvider;->mDownloadXtraDataPending:I

    const/16 v4, 0x3e8

    iput v4, p0, Lcom/android/server/location/GpsLocationProvider;->mFixInterval:I
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mLocation:Landroid/location/Location;

    new-instance v4, Landroid/os/Bundle;

    invoke-direct {v4}, Landroid/os/Bundle;-><init>()V

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mLocationExtras:Landroid/os/Bundle;

    new-instance v4, Ljava/util/ArrayList;

    invoke-direct {v4}, Ljava/util/ArrayList;-><init>()V

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mListeners:Ljava/util/ArrayList;

    new-instance v4, Landroid/os/WorkSource;

    invoke-direct {v4}, Landroid/os/WorkSource;-><init>()V

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mClientSource:Landroid/os/WorkSource;

    new-instance v4, Lcom/android/server/location/GpsLocationProvider$1;

    invoke-direct {v4, p0}, Lcom/android/server/location/GpsLocationProvider$1;-><init>(Lcom/android/server/location/GpsLocationProvider;)V

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsStatusProvider:Landroid/location/IGpsStatusProvider;

    new-instance v4, Lcom/android/server/location/GpsLocationProvider$2;

    invoke-direct {v4, p0}, Lcom/android/server/location/GpsLocationProvider$2;-><init>(Lcom/android/server/location/GpsLocationProvider;)V

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mBroadcastReciever:Landroid/content/BroadcastReceiver;

    new-instance v4, Lcom/android/server/location/GpsLocationProvider$6;

    invoke-direct {v4, p0}, Lcom/android/server/location/GpsLocationProvider$6;-><init>(Lcom/android/server/location/GpsLocationProvider;)V

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mGpsGeofenceBinder:Landroid/location/IGpsGeofenceHardware;

    new-instance v4, Lcom/android/server/location/GpsLocationProvider$7;

    invoke-direct {v4, p0}, Lcom/android/server/location/GpsLocationProvider$7;-><init>(Lcom/android/server/location/GpsLocationProvider;)V

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mNetInitiatedListener:Landroid/location/INetInitiatedListener;

    new-array v4, v6, [I

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mSvs:[I

    new-array v4, v6, [F

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mSnrs:[F

    new-array v4, v6, [F

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mSvElevations:[F

    new-array v4, v6, [F

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mSvAzimuths:[F

    const/4 v4, 0x3

    new-array v4, v4, [I

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mSvMasks:[I

    const/16 v4, 0x78

    new-array v4, v4, [B

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mNmeaBuffer:[B
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mNtpTime:Landroid/util/NtpTrustedTime;

    iput-object p2, p0, Lcom/android/server/location/GpsLocationProvider;->mILocationManager:Landroid/location/ILocationManager;

    new-instance v4, Lcom/android/internal/location/GpsNetInitiatedHandler;

    invoke-direct {v4, p1}, Lcom/android/internal/location/GpsNetInitiatedHandler;-><init>(Landroid/content/Context;)V

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mNIHandler:Lcom/android/internal/location/GpsNetInitiatedHandler;

    iget-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mLocation:Landroid/location/Location;

    iget-object v5, p0, Lcom/android/server/location/GpsLocationProvider;->mLocationExtras:Landroid/os/Bundle;

    invoke-virtual {v4, v5}, Landroid/location/Location;->setExtras(Landroid/os/Bundle;)V
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mWakeLock:Landroid/os/PowerManager$WakeLock;

    iget-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mAlarmManager:Landroid/app/AlarmManager;
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mWakeupIntent:Landroid/app/PendingIntent;
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mTimeoutIntent:Landroid/app/PendingIntent;
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mConnMgr:Landroid/net/ConnectivityManager;
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mAppOpsService:Lcom/android/internal/app/IAppOpsService;
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mBatteryStats:Lcom/android/internal/app/IBatteryStats;

    const/4 v3, 0x0

    .local v3, properties_loaded:Z
    const-string v4, "ro.hardware.gps"

    invoke-static {v4}, Landroid/os/SystemProperties;->get(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    .local v0, gps_hardware:Ljava/lang/String;
    const-string v4, ""
    ...
    .local v2, prop_filename:Ljava/lang/String;
    invoke-direct {p0, v2}, Lcom/android/server/location/GpsLocationProvider;->loadPropertiesFile(Ljava/lang/String;)Z

    move-result v3

    .end local v2           #prop_filename:Ljava/lang/String;
    :cond_0
    if-nez v3, :cond_1

    const-string v4, "/etc/gps.conf"

    invoke-direct {p0, v4}, Lcom/android/server/location/GpsLocationProvider;->loadPropertiesFile(Ljava/lang/String;)Z

    :cond_1
    new-instance v4, Lcom/android/server/location/GpsLocationProvider$ProviderHandler;

    invoke-direct {v4, p0, p3}, Lcom/android/server/location/GpsLocationProvider$ProviderHandler;-><init>(Lcom/android/server/location/GpsLocationProvider;Landroid/os/Looper;)V

    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mHandler:Landroid/os/Handler;
    ...
    new-instance v5, Lcom/android/server/location/GpsLocationProvider$3;

    invoke-direct {v5, p0}, Lcom/android/server/location/GpsLocationProvider$3;-><init>(Lcom/android/server/location/GpsLocationProvider;)V
...
.method private loadPropertiesFile(Ljava/lang/String;)Z
    .locals 7
    .parameter "filename"
    ...
    iput-object v4, p0, Lcom/android/server/location/GpsLocationProvider;->mProperties:Ljava/util/Properties;
    ...
    const-string v6, "unable to parse SUPL_PORT: "
    ...
    const-string v6, "unable to parse C2K_PORT: "

...
.method public final applyConfigurationToResourcesLocked(Landroid/content/res/Configuration;Landroid/content/res/CompatibilityInfo;)Z
    ...
    .local v10, tmpConfig:Landroid/content/res/Configuration;
    ...
    and-int/lit16 v11, v0, 0x300

    if-eqz v11, :cond_b

    const/4 v9, 0x1

    .local v9, themeChanged:Z
    :goto_3
    if-eqz v6, :cond_5
    ...
    .end local v10           #tmpConfig:Landroid/content/res/Configuration;
    invoke-direct {v10}, Landroid/content/res/Configuration;-><init>()V

    .restart local v10       #tmpConfig:Landroid/content/res/Configuration;
    :cond_6
    invoke-virtual {v10, p1}, Landroid/content/res/Configuration;->setTo(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {p0, v3, v10}, Landroid/app/ResourcesManager;->applyNonDefaultDisplayMetricsToConfigurationLocked(Landroid/util/DisplayMetrics;Landroid/content/res/Configuration;)V
    ...
    :cond_8
    invoke-virtual {v8, v10, v3, p2}, Landroid/content/res/Resources;->updateConfiguration(Landroid/content/res/Configuration;Landroid/util/DisplayMetrics;Landroid/content/res/CompatibilityInfo;)V

    :goto_4
    if-eqz v9, :cond_9

    invoke-virtual {v8}, Landroid/content/res/Resources;->updateStringCache()V

    .end local v2           #displayId:I
    .end local v3           #dm:Landroid/util/DisplayMetrics;
    .end local v4           #hasOverrideConfiguration:Z
    .end local v6           #isDefaultDisplay:Z
    .end local v9           #themeChanged:Z
    :cond_9
    :goto_5
    ...
    .restart local v9       #themeChanged:Z
    :cond_c

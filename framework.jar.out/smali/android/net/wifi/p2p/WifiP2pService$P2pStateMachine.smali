...
.method static synthetic access$10000(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;)Ljava/lang/String;
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$10600(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;I)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$10700(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/net/InetAddress;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$10800(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$OngoingGroupRemovalState;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$7500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pConfig;)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
...
.method private addLocalService(Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceInfo;)Z
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;->access$12700(Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;)Ljava/util/List;
...
.method private addServiceRequest(Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceRequest;)Z
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;->access$12600(Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;)Landroid/util/SparseArray;
...
.method private clearClientDeadChannels()V
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;->access$12800(Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;)Landroid/os/Messenger;
...
.method private handleGroupRemoved()V
    ...
    invoke-static {v4}, Landroid/net/wifi/p2p/WifiP2pService;->access$8900(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/net/DhcpStateMachine;
    ...
    invoke-static {v4, v7}, Landroid/net/wifi/p2p/WifiP2pService;->access$8902(Landroid/net/wifi/p2p/WifiP2pService;Landroid/net/DhcpStateMachine;)Landroid/net/DhcpStateMachine;
    ...
    invoke-static {v4}, Landroid/net/wifi/p2p/WifiP2pService;->access$10400(Landroid/net/wifi/p2p/WifiP2pService;)Z
    ...
    invoke-static {v4, v6}, Landroid/net/wifi/p2p/WifiP2pService;->access$10402(Landroid/net/wifi/p2p/WifiP2pService;Z)Z
...
.method private initializeP2pSettings()V
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$12302(Landroid/net/wifi/p2p/WifiP2pService;B)B
    ...
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$12400(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
...
.method private replyToMessage(Landroid/os/Message;I)V
    ...
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$12500(Landroid/net/wifi/p2p/WifiP2pService;)Lcom/android/internal/util/AsyncChannel;

...
.method public static parsePackageLite(Ljava/lang/String;I)Landroid/content/pm/PackageParser$PackageLite;
    ...
    .end local v26           #cookie:I
    :cond_0
    :goto_0
    return-object v30

    .restart local v26       #cookie:I
    :cond_1
    new-instance v29, Landroid/util/DisplayMetrics;

    invoke-direct/range {v29 .. v29}, Landroid/util/DisplayMetrics;-><init>()V

    .local v29, metrics:Landroid/util/DisplayMetrics;
    invoke-virtual/range {v29 .. v29}, Landroid/util/DisplayMetrics;->setToDefaults()V
    ...
    .local v28, errors:[Ljava/lang/String;
    const/16 v30, 0x0

    .local v30, packageLite:Landroid/content/pm/PackageParser$PackageLite;
    :try_start_2
    move-object/from16 v0, v32
    ...
    invoke-interface/range {v31 .. v31}, Landroid/content/res/XmlResourceParser;->close()V
    ...
    .end local v26           #cookie:I
    .end local v28           #errors:[Ljava/lang/String;
    .end local v29           #metrics:Landroid/util/DisplayMetrics;
    .end local v30           #packageLite:Landroid/content/pm/PackageParser$PackageLite;
    .end local v31           #parser:Landroid/content/res/XmlResourceParser;
    ...
    .restart local v26       #cookie:I
    .restart local v28       #errors:[Ljava/lang/String;
    .restart local v29       #metrics:Landroid/util/DisplayMetrics;
    .restart local v30       #packageLite:Landroid/content/pm/PackageParser$PackageLite;
    .restart local v31       #parser:Landroid/content/res/XmlResourceParser;
...
.method public parsePackage(Ljava/io/File;Ljava/lang/String;Landroid/util/DisplayMetrics;I)Landroid/content/pm/PackageParser$Package;
    ...
    .local v25, assmgr:Landroid/content/res/AssetManager;
    const/16 v32, 0x0

    .local v32, res:Landroid/content/res/Resources;
    const/16 v24, 0x1

    .local v24, assetError:Z
    :try_start_0
    new-instance v5, Landroid/content/res/AssetManager;
    ...
    .end local v25           #assmgr:Landroid/content/res/AssetManager;
    .local v5, assmgr:Landroid/content/res/AssetManager;
    :try_start_1
    move-object/from16 v0, p0
    ...
    .local v29, errorText:[Ljava/lang/String;
    const/16 v31, 0x0

    .local v31, pkg:Landroid/content/pm/PackageParser$Package;
    const/16 v28, 0x0

    .local v28, errorException:Ljava/lang/Exception;
    :try_start_4
    move-object/from16 v0, p0
    ...
    .end local v5           #assmgr:Landroid/content/res/AssetManager;
    .end local v28           #errorException:Ljava/lang/Exception;
    .end local v29           #errorText:[Ljava/lang/String;
    .end local v31           #pkg:Landroid/content/pm/PackageParser$Package;
    .restart local v25       #assmgr:Landroid/content/res/AssetManager;
    :catch_2
    move-exception v27

...
local-miui-modified-apps := Music miuisystem SecurityCenter DeskClock Settings MiuiHome MiuiSystemUI Updater TeleService BarcodeScanner DownloadProvider ThemeManager
